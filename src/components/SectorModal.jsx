                ...
                <div style={{ marginTop: 4 }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                    {sector.coveredProtocols.map((p) => (
                      <span key={p} style={{ fontSize: 11, padding: '2px 8px', background: 'var(--surface)', border: '0.5px solid var(--border)', borderRadius: 2, color: 'var(--text-secondary)', fontFamily: 'var(--font-mono)' }}>{p}</span>
                    ))}
                  </div>
                </div>
              )}
